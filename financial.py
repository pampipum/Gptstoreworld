def generate_solar_system_report(area, orientation, slope, mean_radiation, electric_yield, monthly_yield):
    print(f"Received Input Values - Area: {area} sqm, Orientation: {orientation}, Slope: {slope} degrees, Mean Radiation: {mean_radiation} kWh/sqm/year, Electric Yield: {electric_yield} kWh/year")
    ...
    max_num_of_panels = area // PANEL_SIZE
    ...
    annual_savings = annual_yield * AVERAGE_ELECTRICITY_RATE
